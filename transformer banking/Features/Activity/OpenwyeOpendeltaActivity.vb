...
Public Class OpenwyeOpendeltaActivity
    ...
    Private Sub btn_prim_a_4_Click(sender As Object, e As EventArgs) Handles btn_prim_a_1.Click, btn_prim_a_2.Click, btn_prim_a_3.Click, btn_prim_a_4.Click, btn_prim_a_5.Click, btn_prim_a_6.Click,
        ...
        If wire_conenction = 1 Or clamp_meter = 1 Then
            ...
            Else
                ...
                If clamp_meter = 1 Then
                    If h_transformer = "btn_t1_h1" And primary = "a" And clamp_meter = 1 Or h_transformer = "btn_t1_h2" And primary = "n" And clamp_meter = 1 Or h_transformer = "btn_t2_h1" And primary = "b" And clamp_meter = 1 Or h_transformer = "btn_t2_h2" And primary = "n" And clamp_meter = 1 Then
    ...
    Private Sub btn_t1_h1_Click(sender As Object, e As EventArgs) Handles btn_t1_h1.Click, btn_t1_h2.Click, btn_t2_h1.Click, btn_t2_h2.Click
        If wire_conenction = 1 Or clamp_meter = 1 Then
    ...
    Private Sub btn_t1_x1_Click(sender As Object, e As EventArgs) Handles btn_t1_x1.Click, btn_t1_x2.Click, btn_t2_x1.Click, btn_t2_x2.Click
        ...
        Else
            ...
            Else
                ...
                category_2 = "primary"
                If x_transformer = "btn_t1_x1" And secondary = "l3" Or x_transformer = "btn_t2_x1" And secondary = "l2" Or x_transformer = "btn_t2_x2" And secondary = "l1" Then
                    counter_2(myButton.Name, "", clamp_meter)
                ElseIf transformer_1 = "btn_t1_x2" And transformer_2 = "btn_t2_x1" Or transformer_2 = "btn_t1_x2" And transformer_1 = "btn_t2_x1" Then
                    counter_2(myButton.Name, "Blue", clamp_meter)
                ElseIf transformer_1 = "btn_t2_x2" And transformer_2 = "btn_t1_x1" Or transformer_2 = "btn_t2_x2" And transformer_1 = "btn_t1_x1" Then
    ...
    Private Sub btn_clamp_cpblack_Click(sender As Object, e As EventArgs) Handles btn_clamp_cpblack.Click, btn_clamp_cpred.Click
        Dim myButton As Button = CType(sender, Button)
        If ctr_cl_clamp = 1 Then
            ctr = ctr + 1
            ctr_lines = ctr_lines + 1
    ...
    Private Sub btn_t1_x_Click(sender As Object, e As EventArgs) Handles btn_t1_x.Click, btn_t2_x.Click
        If ctr_cl_clamp = 1 Then
            Dim myButton As Button = CType(sender, Button)
            'category = "primary"
    ...
    Private Sub pic_switch_Click(sender As Object, e As EventArgs) Handles pic_switch.Click
        ...
        Dim query = "select * from openwye_opendelta_lines where clamp_meter::integer >= 1 and transformer_details_id = '" & transformer_id & "' order by id asc"
        Dim da As New Odbc.OdbcDataAdapter(query, conn)
        Dim dt As New DataTable
        da.Fill(dt)
    ...
    Private Sub btn_l2red_MouseDown(sender As Object, e As MouseEventArgs) Handles btn_l1red.MouseDown, btn_l1black.MouseDown, btn_l2red.MouseDown, btn_l2black.MouseDown, btn_l3red.MouseDown, btn_l3black.MouseDown
        If e.Button = MouseButtons.Right Then
...
#Region "subs"
    ...
    Private Sub select_clamp_line()
        Dim query = "select * from openwye_opendelta_lines where clamp_meter = '1' and transformer_details_id = '" & transformer_id & "' order by id asc"
        Dim da As New Odbc.OdbcDataAdapter(query, conn)
        Dim dt As New DataTable
        da.Fill(dt)
    ...
    Private Sub select_clamp_phase()
        Dim query = "select * from openwye_opendelta_lines where clamp_meter = '6' and transformer_details_id = '" & transformer_id & "' order by id asc"
        Dim da As New Odbc.OdbcDataAdapter(query, conn)
        Dim dt As New DataTable
        da.Fill(dt)
    ...
    Private Sub btn_prim_n_6_MouseDown(sender As Object, e As MouseEventArgs) Handles btn_prim_a_1.MouseDown, btn_prim_a_2.MouseDown, btn_prim_a_3.MouseDown, btn_prim_a_4.MouseDown, btn_prim_a_5.MouseDown, btn_prim_a_6.MouseDown,
