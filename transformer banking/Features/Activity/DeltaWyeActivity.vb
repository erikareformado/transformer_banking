...
Public Class DeltaWyeActivity
    ...
    Private Sub btn_t2_h1_Click(sender As Object, e As EventArgs) Handles btn_t1_h1.Click, btn_t1_h2.Click, btn_t2_h1.Click, btn_t2_h2.Click, btn_t3_h2.Click, btn_t3_h1.Click
    ...
    Private Sub btn_sec_n_4_Click(sender As Object, e As EventArgs) Handles btn_sec_n_1.Click, btn_sec_n_2.Click, btn_sec_n_3.Click, btn_sec_n_4.Click, btn_sec_n_5.Click, btn_sec_n_6.Click,
    ...
    Private Sub btn_t3_x1_Click(sender As Object, e As EventArgs) Handles btn_t1_x1.Click, btn_t1_x2.Click, btn_t2_x1.Click, btn_t2_x2.Click, btn_t3_x1.Click, btn_t3_x2.Click
        Dim myButton As Button = CType(sender, Button)
    ...
    Private Sub pic_switch_Click(sender As Object, e As EventArgs) Handles pic_switch.Click
        ...
        Dim query = "select * from delta_wye_lines where clamp_meter::integer >= 1 and transformer_details_id = '" & transformer_id & "' order by id asc"
        ...
        If e.Button = MouseButtons.Right Then
            ...
            If result = DialogResult.Yes Then
                If ctr_switch <> 1 Then
                    ...
                    query = "select * from delta_wye_lines order by id asc"
                    Dim da As New Odbc.OdbcDataAdapter(query, conn)
                    Dim dt As New DataTable
                    da.Fill(dt)
                    For counter As Integer = 0 To dt.Rows.Count - 1
    ...
    Private Sub btn_clamp_meter_Click(sender As Object, e As EventArgs) Handles btn_clamp_meter.Click
        Dim clamp_ctr = delta_wye_model.select_clamp_count()
        If clamp_ctr = 0 Then
            clamp_meter = 1
    ...
    Private Sub pic_clamp_meter_cp_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles pic_clamp_meter_cp.MouseDoubleClick
        If e.Button = MouseButtons.Right Then
            ...
            If result = DialogResult.Yes Then
                If ctr_switch <> 1 Then
                    ...
                    query_delete = "delete from delta_wye_lines where clamp_meter in ('6','7')"
                    Dim da_delete As New Odbc.OdbcDataAdapter(query_delete, conn)
                    Dim dt_delete As New DataTable
                    da_delete.Fill(dt_delete)
    ...
    Private Sub pic_clamp_meter_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles pic_clamp_meter.MouseDoubleClick
        If e.Button = MouseButtons.Right Then
            ...
            If result = DialogResult.Yes Then
                If ctr_switch <> 1 Then
                    Dim query_delete As String
                    query_delete = "delete from delta_wye_lines where clamp_meter in ('1','2')"
                    Dim da_delete As New Odbc.OdbcDataAdapter(query_delete, conn)
                    Dim dt_delete As New DataTable
                    da_delete.Fill(dt_delete)
    ...
    Private Sub btn_prim_a_4_MouseDown(sender As Object, e As MouseEventArgs) Handles btn_prim_a_1.MouseDown, btn_prim_a_2.MouseDown, btn_prim_a_3.MouseDown, btn_prim_a_4.MouseDown, btn_prim_a_5.MouseDown, btn_prim_a_6.MouseDown,
    ...
    Private Sub btn_try_again_Click(sender As Object, e As EventArgs) Handles btn_try_again.Click
        ...
        If result = DialogResult.Yes Then
            ...
            Dim btn = myButton.Name
            Dim query As String
            query = "delete from delta_wye_lines"
            Dim da As New Odbc.OdbcDataAdapter(query, conn)
            Dim dt As New DataTable
            da.Fill(dt)
...
#Region "subs"
    ...
    Private Sub select_clamp_line()
        Dim query = "select * from delta_wye_lines where clamp_meter = '1' and transformer_details_id = '" & transformer_id & "' order by id asc"
        Dim da As New Odbc.OdbcDataAdapter(query, conn)
        Dim dt As New DataTable
        da.Fill(dt)
    ...
    Private Sub select_clamp_phase()
        Dim query = "select * from delta_wye_lines where clamp_meter = '6' and transformer_details_id = '" & transformer_id & "' order by id asc"
        Dim da As New Odbc.OdbcDataAdapter(query, conn)
        Dim dt As New DataTable
        da.Fill(dt)
    ...
    Public Sub get_point()
        Dim array_points = delta_wye_model.select_delta_wye_points(transformer_id)
        Dim count_points = delta_wye_model.select_count_delta_wye_points(transformer_id)
    ...
    Private Sub draw_lines(ByVal e As PaintEventArgs)
        ...
        Dim arry_color = delta_wye_model.select_color(transformer_id)
